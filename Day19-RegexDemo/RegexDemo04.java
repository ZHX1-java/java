...
public class RegexDemo04 {
    public static void main(String[] args) {
        ...
        */
        ...
        //验证手机号
        // 第一部分：  1   表示手机号只能是1开头的
        // 第二部分：  [3-9]  表示手机号第二位只能是 3到9之间的数字
        // 第三部分：  \\d{9}  表示手机号后9位是任意数字，只能出现9次，也只能出现9次
        ...
        //验证座机电话号码
        //思路：
        //在书写座机号码正则的时候需要把正确的数据分为三部分
        //一：区号   0\\d{2,3}
        //          0：表示区号一定是0开头的
        //          \\d{2,3}：表示区号从第二位开始可以是任意数字，可以出现2到3次
        //二： -      ?表示次数，0次或一次
        //三： 号码   号码的第一位也不能0开头，从第二位开始可以是任意数字，号码的总长度：5-10位
        ...
        System.out.println("23:53:50".matches(regex4));

        //优化
        String regex5 = "([01]\\d|2[0-3])(:[0-5]\\d){2}";
        System.out.println("23:53:50".matches(regex5));
    }
}
